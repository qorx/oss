...
Here's an example of how to use [QOR OSS](https://github.com/qorx/oss) with S3. After initializing the s3 storage, The functions in the interface are available.
